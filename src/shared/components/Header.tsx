...
import { usePostLogout } from "@/src/widgets/auth/feature/mutation/usePostLogout";
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* 로그아웃 확인 모달 */}
      {showLogoutConfirm &&
        <LogoutModal handleLogoutCancel={handleLogoutCancel} handleLogoutConfirm={handleLogoutConfirm} />}
    </>
  );
}
